...
#'
#' @param lfun lfun
#' @param x used to create plot, locate point of intersect with param
#' @param param used to create plot, locate point of intersect with x
#'
#' @return p vs y plot of liklihood
#' @export
#'
#' @examples
